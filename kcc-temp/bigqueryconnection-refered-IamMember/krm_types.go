...
type MemberSource struct {
	...
	// The BigqueryConnection whose service account (i.e. its
	// 'status.serviceAccountId') is to be bound to the role.
	BiqgueryConnectionRef *MemberReference `json:"bigqueryConnectionRef,omitempty"`
