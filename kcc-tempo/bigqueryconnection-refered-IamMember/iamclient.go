...
const (
	...
	BigqueryConnectionKind    = "BigQueryConnectionConnection"
	BigqueryConnectionGroup   = "bigqueryconnection.cnrm.cloud.google.com"
	BigqueryConnectionVersion = "v1alpha1"
...
var (
	...
	BigqueryConnectionGVK = schema.GroupVersionKind{
		Group:   BigqueryConnectionGroup,
		Version: BigqueryConnectionVersion,
		Kind:    BigqueryConnectionKind,
	}
